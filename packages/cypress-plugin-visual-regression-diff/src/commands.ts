...
// to; `cy.screenshot` renders in the browser Cypress drives (Electron unless
// `--browser` says otherwise), so that is the browser
export const getPathVariables = (): PathVariables => ({
  os: Cypress.platform,
